...
class WorkerModeResetTest extends TestCase
{
    ...
    public function testHealthServiceResetClearsInProcessMemo(): void
    {
        ...
        // Simulate a request having populated the 10 s in-process memo and
        // memoized the shared-pool generation token.
        ...
        $this->assertNull($generation->getValue($service), 'generation memo must be nulled on reset so a recycled worker re-reads the pool token');
    }

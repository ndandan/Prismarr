...
class BazarrSubtitleIndexPatchTest extends TestCase
{
    ...
    /**
     * Fix round 1, IMPORTANT 2: refreshItem() must never trust $rows[0]
    ...
    /**
     * Fix round 1, IMPORTANT 4: cover the 'series' branch of refreshItem()
    ...
    /**
     * Fix round 1, IMPORTANT 4: the journal must actually prune entries older
    ...
    /**
     * Fix round 1, MINOR 7: journalPatch()/patchPooledMap() run on the

...
class BazarrSubtitleIndexSingleTest extends TestCase
{
    ...
    /**
     * Fix round 1, IMPORTANT 1: a filter param Bazarr ignored (or a
    ...
    /**
     * Fix round 1, IMPORTANT 3: a broken pool must not turn a quick-look open
    ...
    /**
     * MINOR (fix round 1): reset() must clear the $singles per-request memo
     * (worker-mode safety guardrail 2) — a second lookup after reset() is a
